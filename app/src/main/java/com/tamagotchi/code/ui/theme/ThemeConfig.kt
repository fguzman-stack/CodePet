...
object ThemeRegistry {
    val allThemes = listOf(
        ...
        AppTheme(
            ...
            primary = Color(0xFFBC4F6C),
            secondary = Color(0xFFF4B8C8),
            tertiary = Color(0xFFDCA6B4),
            onPrimary = Color.White,
            textPrimary = Color(0xFF4A3B3E),
            textSecondary = Color(0xFF7A6268),
            accent = Color(0xFFBC4F6C),
            success = Color(0xFF3E7D67),
            error = Color(0xFFB3393B),
